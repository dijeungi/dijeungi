...
기획/디자인부터 개발, 배포, 운영까지 AI를 활용해 혼자서 프로젝트를 완성합니다.

### Experience

- 1인 창업 / 0 to 1 Product Builder (2025.09 ~ )
    - 학원 수료생 개발 커뮤니티/블로그 플랫폼 (지식 공유,공고,네트워킹) (25.11 ~ 진행 중)
    - 지하철 익명 채팅 서비스 (개발에 필요한 데이터 확보가 어려워 프로젝트 중단) (25.08 ~ 25.09)
...
- 온라인 학점은행제 - 컴퓨터공학 학사과정 이수 중 (24.08 ~ 27.02)
